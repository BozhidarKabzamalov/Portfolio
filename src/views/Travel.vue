    ...
    <div>
        <main class='wrapper'>
            ...
            <div class="image-container">
                <img class='project-image' src="@/assets/traveldiary/travel1.jpg" alt="Landing Page">
            </div>
            ...
            <div class="image-container">
                <img class='project-image' src="@/assets/traveldiary/travel2.jpg" alt="Landing Page">
            </div>
            <div class="image-container">
                <img class='project-image' src="@/assets/traveldiary/travel3.jpg" alt="Landing Page">
            </div>
        </main>
        <Footer></Footer>
    </div>
